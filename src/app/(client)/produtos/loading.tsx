  ...
  return (
    <div className="container py-8 animate-pulse">
      ...
      <div className="flex items-center justify-between mb-6">
        <div className="h-8 w-48 bg-gray-200 dark:bg-dark-3 rounded-lg" />
        <div className="h-9 w-36 bg-gray-200 dark:bg-dark-3 rounded-lg" />
      </div>
      {/* Filters skeleton */}
      <div className="flex gap-3 mb-4">
        <div className="h-9 w-56 bg-gray-200 dark:bg-dark-3 rounded-lg" />
        <div className="h-9 w-40 bg-gray-200 dark:bg-dark-3 rounded-lg" />
        <div className="h-9 w-32 bg-gray-200 dark:bg-dark-3 rounded-lg" />
      </div>
      {/* Table skeleton */}
